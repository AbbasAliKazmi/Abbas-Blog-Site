...
export default function Footer() {
  ...
  return (
    <footer className="pt-10 bg-gray-800 mt-10">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="justify-between items-center gap-12 md:flex">
          <div className="flex-1 max-w-lg">
            <h3 className="text-white text-2xl font-bold">
              Chechout the latest news from our Blogs
            </h3>
          </div>
        ...
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          <p className="text-gray-300">© 2024 Abbas Kazmi Inc. All rights reserved.</p>
          <div className="flex items-center gap-x-6 text-gray-400 mt-6">
            <a href="javascript:void()">
              {/* Add your SVG code here for the first social media icon */}
            </a>
            {/* Repeat the above line for other social media icons */}
          </div>
        </div>
      </div>
    </footer>
